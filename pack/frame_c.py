...
class frame_c(ttk.Frame):
    ...
    def init(self, *args):
        ...
        self.richang = ({'帮派强盗   ': ('12:30:00', '--:--:--'), '竞技场活动1': ('13:00:00', '14:00:00'), '门派争霸  ': ('21:00:00', '21:40:00'), 
                        ...
                        {'不周山神   ': ('11:00:00', '--:--:--'), '剑会群英   ': ('12:00:00', '20:00:00'), '小猪快跑  ': ('12:00:00', '18:00:00'), 
                        '科举会试1   ': ('13:00:00', '--:--:--'), '科举与不周 ': ('15:00:00', '--:--:--'), '不周山神  ': ('19:00:00', '--:--:--'), 
                        '科举会试3   ': ('20:00:00', '--:--:--'), '决战九华山 ': ('21:00:00', '22:00:00'), '帮派车轮战': ('22:00:00', '23:00:00'), 
                        '不周山神    ': ('23:00:00', '--:--:--')},

                        {'不周山神   ': ('11:00:00', '--:--:--'), '剑会群英   ': ('12:00:00', '20:00:00'), '帮派秘境  ': ('12:30:00', '13:30:00'), 
                         '不周山神   ': ('15:00:00', '--:--:--'), '擂台大挑战 ': ('17:00:00', '20:00:00'), '梦幻迷城  ': ('18:30:00', '20:00:00'), 
                         '不周山神   ': ('19:00:00', '--:--:--'), '比武大会   ': ('21:00:00', '22:20:00'), '比武-结束 ': ('22:20:00', '--:--:--'), 
                         '不周山神   ': ('23:00:00', '--:--:--')}, )
